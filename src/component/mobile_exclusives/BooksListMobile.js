...
export default function BooksList(props) {
    ...
    useEffect(() => {
        ...
        {
            fetch(`http://ec2-3-83-118-168.compute-1.amazonaws.com:3001/books/${props.user.recentBooks[0]}`).then(res => res.json()).then((result) => {setData(data => [...data,result]);setLoadingData1 (false); },(error) => {setError(error);})
        }
        ...
        {
            fetch(`http://ec2-3-83-118-168.compute-1.amazonaws.com:3001/books/${props.user.recentBooks[1]}`).then(res => res.json()).then((result) => {setData(data => [...data,result]);setLoadingData2 (false); },(error) => {setError(error);})
        }
        ...
        {
            fetch(`http://ec2-3-83-118-168.compute-1.amazonaws.com:3001/books/${props.user.recentBooks[2]}`).then(res => res.json()).then((result) => {setData(data => [...data,result]);setLoadingData3 (false); },(error) => {setError(error);})
        }
        ...
        {
            fetch(`http://ec2-3-83-118-168.compute-1.amazonaws.com:3001/books/${props.user.recentBooks[3]}`).then(res => res.json()).then((result) => {setData(data => [...data,result]);setLoadingData4 (false); },(error) => {setError(error);})
        }
        ...
        {
            fetch(`http://ec2-3-83-118-168.compute-1.amazonaws.com:3001/books/${props.user.recentBooks[4]}`).then(res => res.json()).then((result) => {setData(data => [...data,result]);setLoadingData5 (false); },(error) => {setError(error);})
        }
