...
export const AddReview = (props) => {
    ...
    async function handleClick(event) {
        ...
        if(editFlag) {
            ...
            fetch(`http://ec2-3-83-118-168.compute-1.amazonaws.com:3001/reviews/${reviewData._id}`, {
                method: 'PATCH',
        ...
        // POST the review
        const response = await fetch('http://ec2-3-83-118-168.compute-1.amazonaws.com:3001/reviews', {
            method: 'POST',
            // The headers is required for it to work
            headers: {
                'Content-Type': 'application/json'
        ...
        fetch(`http://ec2-3-83-118-168.compute-1.amazonaws.com:3001/users/${userData._id}`, {
            method: 'PATCH',
            // The headers is required for it to work
            headers: {
                'Content-Type': 'application/json'
